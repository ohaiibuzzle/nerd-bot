...
class Embeds:
    ...
    async def helpEmbed(ctx):
        ...
        commands_embed.add_field(name = "To get the details about the bot", value = "`!info`", inline = False)
        commands_embed.add_field(name="For a hello request: ", value = "`!hello`", inline = False)
        commands_embed.add_field(name = "For a typing task:", value = "`!typee`", inline = False)
        commands_embed.add_field(name= "To get a brain twister", value = "`!word`", inline = False)
        ...
        commands_embed.add_field(name = "For a wikipedia search:", value = "`!wiki [Write the topic which you want to search.. Wihtout the 'w' words]`", inline = False)
        commands_embed.add_field(name = "To get your avatar as an image:", value = "`!avatar`", inline = False)
        commands_embed.add_field(name = "Create your account to earn points ", value = "!`createac`", inline = False)
        commands_embed.add_field(name = "Delete your account: [Not recommended]", value = "`!deleteac`", inline = False)
        commands_embed.add_field(name = "Checkout your score:", value = "`!myscore`")
        commands_embed.add_field(name = "Get a random gif:", value = "`!gif [Any emotion eg. Smile, happy etc.]`", inline = False)
        commands_embed.add_field(name = "Get a quadratic polynomial with its zeroes", value = "`!polynomial [alpha] [beta] {Here alpha and beta are the zeroes. give a space between them}`", inline = False)
        commands_embed.add_field(name = "Improve your vocabulary daily: ", value="`!vocab`", inline = False)
        commands_embed.add_field(name = "View the nerd-shop: ", value = "`!shop`", inline = False)
        commands_embed.add_field(name = "To view a specific item:", value = "`!item <name>`", inline=False)
        commands_embed.add_field(name = "To buy an item", value = "`!buy <item>`", inline= False)
        commands_embed.add_field(name="Check your inventory", value = "`!inventory`", inline=False)
        await ctx.send(embed = commands_embed)
        if ctx.guild.owner_id == ctx.author.id:
            owner_commands = discord.Embed(title = "Owner Specific Commands", color = 0xffa00f)
            owner_commands.add_field(name = "To create a new channel", value = "`!createchannel [name] [category]`", inline = False)
            owner_commands.add_field(name = "To delete a channel", value = "`!deletechannel [name]`", inline = False)
